                ...
                <div class="col-md-4 col-lg-4">
                    <div class="product-message-left space--left">
						...
						<div class="space-top">
                             ...
                             <textarea class=" describe font--content input-padding" rows="3" cols="30" name="declaration_element" placeholder="请填写海关要求的申报格式,如若不会，可为空"  ><?php echo $goods['declaration_element'];?></textarea>
                        </div>
