  ...
  <div class="company-main">
    <form action="<?php echo Yii::$app->urlManager->createUrl(['/company/company-auth']);?>" enctype="multipart/form-data" method="post">
      ...
      <div class="company-part">
        ...
        <div class="company-right"><input id="company-expect-money" type="" name='company[expect_credit]' value="" />
        </div>
      </div>
      <div class="company-part">
        <div class="company-left">
        ...
        <div class="company-right">
          ...
          <label><input name="company[expect_days]" type="radio" value="2">&nbsp&nbsp120天</label> 
        </div>
      </div>
      <div class="company-part">
        <div class="company-left">
