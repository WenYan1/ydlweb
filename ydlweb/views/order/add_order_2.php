		...
		<div class="space-vertical base-message" style="">
			...
			<div class="info-custom" >
				...
				<div class="info-custom">
					<div class="order-inf">
						<p>订单总金额(元)：
							<span id="invoice_amount"><?php echo $order_goods['total_price'] ?></span>
							<input type="hidden" name="order_info[invoice_amount]" value="<?php echo $order_goods['total_price'] ?>" />
						</p>
					</div>
